...
<div class="container" style="background-color: #F2F2F2; ">
    <div class="row hidden-xs" style="background-color:#FFF;">
        ...
        <a href="<?php echo "http://".$_SERVER['HTTP_HOST']."/prize.php"; ?>"><span style="width:13.8%" class="HPtopmenu2">未来·大奖</span></a>
    ...
    <div class="row">
        ...
        <div id="barmenu-content" style="display: none; position: absolute; right:0; width:66%; background-color: rgb(80,80,80); z-index:99999; padding: 10% 0">
            ...
            <a href="<?php echo "http://".$_SERVER['HTTP_HOST']."/prize.php"; ?>"><div class="HPtopmenucollapse" style="padding: 10%;">未来·大奖</div></a>
