                                    ...
                                    <div class="cbp-caption-defaultWrap">
                                        <div class="row" style="margin:0">
                                            <div class="col-xs-6 col-sm-12" style="padding:0">
                                                <div class="hidden-xs">
                                                <a class="" href="<?php echo "http://".$_SERVER['HTTP_HOST']."/"; ?>footprints/<?php echo $event['id']; ?>.html"><img src="contents/eventthumb/<?php echo $event['code']; ?>.jpg" alt=""></a>
                                                </div>
                                                <div class="hidden-sm hidden-md hidden-lg">
                                                <a class="" href="<?php echo "http://".$_SERVER['HTTP_HOST']."/"; ?>footprints/<?php echo $event['id']; ?>.html"><img src="contents/eventthumb_b/<?php echo $event['code']; ?>.jpg" alt=""></a>
                                                </div>
                                            </div>
